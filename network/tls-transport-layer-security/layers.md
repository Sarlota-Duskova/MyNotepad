...
* A protocol for creating a secure communication channel over the Internet
...
* The MAC address is a twelve-character hexadecimal number (a base sixteen numbering system)
...
Datagram => UDP is connectionless protocol

Segments => TCP is a connection-based protocol
